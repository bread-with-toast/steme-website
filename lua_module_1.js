...
function mark() {
    ...
    let surround = document.getElementById("stringsurround")
    let functionprint = document.getElementById("textconsole")

    if (surround.value.toLowerCase() == "quotation marks") {
        first = 1
